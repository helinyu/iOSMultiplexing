...
typedef NS_ENUM(NSInteger, TalkRequestType) {
    TalkRequestTypeText = 0x00,
    TalkRequestTypeThumbsUP = 0x01,
    TalkRequestTypeFollow = 0x02,
    TalkRequestTypeEnterRoom = 0x03,
    TalkRequestTypeExitRoom = 0x04
};

typedef NS_ENUM(NSInteger, LiveMessageType) {
    LiveMessageTypeText = 0x00,
    LiveMessageTypeLike = 0x01,
    LiveMessageTypeFollow = 0x02,
    LiveMessageTypeEnterRoom = 0x03,
    LiveMessageTypeExitRoom = 0x04
};
...
@interface LivePackage_EnterRoomRequest : LivePackage
...
@property (assign, nonatomic) NSInteger result;
@property (strong, nonatomic) NSMutableArray<LivePackage_UserInfo*>* userInfo;
@property (strong, nonatomic) LivePackage_EnterRoomStatement* statement;
@property (strong, nonatomic) NSString *clientId;
@property (assign, nonatomic) NSInteger likeTotal;
@end
...
@interface LivePackage_TalkRequest : LivePackage
...
@property (strong, nonatomic) NSString *mId;
@property (strong, nonatomic) NSString *content;
@property (assign, nonatomic) LiveMessageType type;
@property (assign, nonatomic) NSTimeInterval time;
...
@protocol LivePackage_RoomCloseBroadcastStatement <NSObject>
@end
@interface LivePackage_RoomCloseBroadcastStatement : LivePackage
@property (assign, nonatomic) NSInteger likeTotal;
...
@property (strong, nonatomic) LivePackage_RoomCloseBroadcastStatement *statement;
@property (assign, nonatomic) NSInteger reason;
@end
...
@interface LivePackage_HeartHeat : LivePackage
@end

@interface LivePackage_UserSilencePush : LivePackage
@property (strong, nonatomic) NSString *uesrId;
@end

@interface LivePackageFactory: NSObject
